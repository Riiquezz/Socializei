         ...
         { (user.info.nickname || user.info.status ) && <div className="profile__info">
            {user.info.nickname && (
              <div className="profile__info-basic">
                <div className="profile__info-header font-lg">Informações básicas</div>
                <ul className="profile__info-list ">
                  <li>
                    Nome : <span className="ald">{user.info.nickname}</span>{" "}
                  </li>
                  <li>
                    Gênero : <span className="ald">{user.info.gender}</span>{" "}
                  </li>

                  <li>
                    Aniversário : <span className="ald">{user.info.date}</span>{" "}
                  </li>
                  <li>
                    País : <span className="ald">{user.info.country}</span>{" "}
                  </li>
                </ul>
              </div>
            )}
